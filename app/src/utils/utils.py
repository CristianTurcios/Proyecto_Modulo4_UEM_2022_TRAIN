...
class IBMCOS:
    ...
    def save_object_in_cos(self, obj, name, timestamp, bucket_name='models-uem-cturcios-train'):
        """
    ...
    def get_object_in_cos(self, key, bucket_name='models-uem-cturcios-train'):
        """
